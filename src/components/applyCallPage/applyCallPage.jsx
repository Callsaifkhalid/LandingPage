...
// import SchedulePopup from "@/components/callSchedule/callSchedule";
import dayjs from "dayjs";
import { FaTimes } from "react-icons/fa";
import { setConfig } from "next/config";
const ApplyCallPage = ({ click }) => {
      ...
      <div className={styles.calculator}>
        <div className={styles.calculatorScreens}>
          ...
          <div className={styles.buttons}>
            ...
            <button className={styles.button2} onClick={handlescheduleclick}>
              Schedule a Call
            </button>
          </div>
          ...
          {call === 3 && (
            <span>
              Thanks, we will call you on {calldate} at {calltime}
            </span>
          )}
        </div>
      </div>
